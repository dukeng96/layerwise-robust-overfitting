        ...
        if not args.eval:
            ...
            if epoch == 199 and args.target_layers == [3, 4]:
                torch.save({
                        ...
                        'test_loss':test_loss/test_n,
                        'test_acc':test_acc/test_n,
                    }, os.path.join(MODEL_PATH, f'awp_{args.model}_cifar10_{args.norm}_{args.target_layers}_last.pth'))
            ...
            if test_robust_acc/test_n > best_test_robust_acc and args.target_layers == [3, 4]:
                torch.save({
                        ...
                        'test_loss':test_loss/test_n,
                        'test_acc':test_acc/test_n,
                    }, os.path.join(MODEL_PATH, f'awp_{args.model}_cifar10_{args.norm}_{args.target_layers}_best.pth'))
