...
def main():
    ...
    opt = torch.optim.SGD([{'params': base_params}, {'params': params, 'lr': args.lr_max}], lr=args.lr_max,
                          momentum=0.9,
                          weight_decay=5e-4)
    logger.info(
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if not args.eval:
            ...
            if epoch == 199 and args.target_layers == [3, 4]:
                ...
                }, os.path.join(MODEL_PATH, f'fixlr_{args.model}_svhn_{args.norm}_{args.target_layers}_last.pth'))
            ...
            if test_robust_acc / test_n > best_test_robust_acc and args.target_layers == [3, 4]:
                torch.save({
                    ...
                    'test_loss': test_loss / test_n,
                    'test_acc': test_acc / test_n,
                }, os.path.join(MODEL_PATH, f'fixlr_{args.model}_svhn_{args.norm}_{args.target_layers}_best.pth'))
